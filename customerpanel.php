...
<button 
    style="display: block; margin: 0 auto; background-color: green; color: white; padding: 15px 30px; border: none; border-radius: 5px; font-size: 16px; cursor: pointer; transition: transform 0.3s ease;" 
    onclick="window.location.href='displaysales.php';">
   Go To The Market
</button>
